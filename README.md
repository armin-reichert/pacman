...
Whatever decision you took, the important thing IMHO is that you took a decision at all and do not reinvent the implementation for each use case. And now you can concentrate on the "real" stuff: 
